...
public class RegisterRepo {
    ...
    private String first_name,last_name,email,mobile,password;
    Context context;
    VolleySingleton volleySingleton;
    RequestQueue requestQueue;
    private String url = AppConfig.RIDER_WEB_URL+"Register.php";
    General general;

    public RegisterRepo(Context context, String first_name,String last_name,String email, String mobile,String password){
